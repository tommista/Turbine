...
public class TurbineModule {
  ...
  @Provides @Singleton public Handles providesHandles(
      @SavedHandlesPreference StringPreference stringPreference) {
    ...
    RequestInterceptor reqInterceptor = new RequestInterceptor() {
      ...
      public void intercept(RequestFacade requestFacade) {
        requestFacade.addHeader("Authorization",
            "Bearer " + application.getResources().getString(R.string.twitter_token));
      }
    };

    RestAdapter restAdapter = new RestAdapter.Builder().setEndpoint(
        application.getResources().getString(R.string.twitter_api_endpoint))
  ...
  @Provides @Singleton UnshortenService providesUnshortenService(Application application) {
    RestAdapter restAdapter = new RestAdapter.Builder().setEndpoint(
        application.getResources().getString(R.string.unshorten_api_endpoint))
  ...
  @Provides @Singleton @SavedHandlesPreference
  public StringPreference providesSavedHandlesPreference(Application application,
      SharedPreferences preferences) {
    return new StringPreference(preferences,
        application.getResources().getString(R.string.saved_handles_list_key));
  }
  ...
  @Provides @Singleton DataFuser providesDataFuser(Application application,
      TimelineService timelineService, UnshortenService unshortenService, Handles handles,
      Tweets tweets) {
